...
namespace Billy\Mpdf\PsrHttpMessageShim;

use Billy\Psr\Http\Message\StreamInterface;
use Billy\Psr\Http\Message\ResponseInterface;
use Billy\Psr\Http\Message\MessageInterface;
 ...
 */
class Response implements \Billy\Psr\Http\Message\ResponseInterface
{
	...
	/** @var \Billy\Psr\Http\Message\StreamInterface */
	private $stream;
