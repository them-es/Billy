...
class Tag
{
	...
	/**
	 * @param \Billy\Mpdf\Mpdf $mpdf
	 * @param \Billy\Mpdf\Cache $cache
	 * @param \Billy\Mpdf\CssManager $cssManager
	 * @param \Billy\Mpdf\Form $form
	 * @param \Billy\Mpdf\Otl $otl
	 * @param \Billy\Mpdf\TableOfContents $tableOfContents
	 * @param \Billy\Mpdf\SizeConverter $sizeConverter
	 * @param \Billy\Mpdf\Color\ColorConverter $colorConverter
	 * @param \Billy\Mpdf\Image\ImageProcessor $imageProcessor
	 * @param \Billy\Mpdf\Language\LanguageToFontInterface $languageToFont
	 */
