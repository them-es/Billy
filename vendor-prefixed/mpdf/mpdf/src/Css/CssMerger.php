...
namespace Billy\Mpdf\Css;

use Billy\Mpdf\Color\ColorConverter;
use Billy\Mpdf\CssManager;
use Billy\Mpdf\Exception\InvalidArgumentException;
use Billy\Mpdf\Mpdf;
...
class CssMerger
{
	...
	/**
	 * @var \Billy\Mpdf\Css\NormalizeProperties
	 */
	private $normalizeProperties;

	/**
	 * @var \Billy\Mpdf\Css\InlineStyleParser
	 */
	private $inlineStyleParser;

	/**
	 * @var \Billy\Mpdf\Css\SelectorParser
	 */
	private $selectorParser;

	/**
	 * @var \Billy\Mpdf\Css\InlinePropertyConverter
	 */
	...
	/**
	 * @var \Billy\Mpdf\Css\BorderMerger
	 */
