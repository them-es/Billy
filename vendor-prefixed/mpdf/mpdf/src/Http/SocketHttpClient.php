...
use Billy\Mpdf\PsrHttpMessageShim\Response;
use Billy\Mpdf\PsrHttpMessageShim\Stream;
...
class SocketHttpClient implements \Billy\Mpdf\Http\ClientInterface, \Billy\Psr\Log\LoggerAwareInterface
{
